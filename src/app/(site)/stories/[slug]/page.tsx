...
import { fetchStory, fetchStories, fetchStoryPhotos, publicUrl } from "@/lib/data";
...
/** Minimal markdown: blank-line separated paragraphs. */
    ...
    <div className="pt-[7.5rem]">
      ...
      <header className="grain relative overflow-hidden bg-navy-700 py-16 text-cream-200 md:py-20">
        ...
        <div className="shell relative max-w-3xl">
          ...
          <h1 className="mt-4 font-display text-display font-extrabold !text-white">
            {story.title}
          </h1>
      ...
      <section className="section bg-cream-100">
        <div className="shell grid gap-12 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div className="max-w-2xl">
            {story.excerpt ? (
              <p className="font-display text-h3 leading-snug text-forest-900">
                {story.excerpt}
              </p>
            ) : null}
